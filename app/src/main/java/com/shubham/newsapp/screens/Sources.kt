...
@Composable
fun Sources(innerPadding: PaddingValues, navController: NavController, newsManager: NewsManager) {
    ...
    Scaffold(topBar = {
        TopAppBar(
            title = {
                Text("${newsManager.sourceName.value} Source", fontWeight = FontWeight.SemiBold)
            },
                    ...
                    DropdownMenu(
                        ...
                        items.forEach { (key, value) ->
                            DropdownMenuItem(
                                text = { Text(key) },
                                onClick = {
                                    newsManager.sourceName.value = value
            ...
            newsManager.getArticlesBySources()
            val articleList = newsManager.articleBySources.value.articles
            if (articleList != null) {
